...
} shipping_addresses_t;


extern shipping_addresses_t *shipping_addresses;


int fgg__shipping_addresses__init  (void);
int fgg__shipping_addresses__config (const char *sdb_path);
int fgg__shipping_addresses__start  (void);
int fgg__shipping_addresses__sdb__select_count_form_shipping_addresses (unsigned long *count);
int fgg__shipping_addresses__sdb__select_shipping_address_from_shipping_addresses (unsigned long pk_id, utils__sdb_t *data, int* active, unsigned long lang);
int fgg__shipping_addresses__sdb__insert_shipping_address_into_shipping_addresses (unsigned long pk_id, const utils__sdb_t *sdb, unsigned long active);
int fgg__shipping_addresses__present_shipping_addresses (unsigned long presentation_mode, utils__sdb_t *sdb, char *buffer, unsigned long buffer_size, unsigned long *buffer_len);
int fgg__shipping_addresses__sdb__make_new_data_id (unsigned long *pk_id);
int fgg__shipping_addresses__sdb__index_file (void);
void fgg__shipping_addresses__set_module_data (void);
