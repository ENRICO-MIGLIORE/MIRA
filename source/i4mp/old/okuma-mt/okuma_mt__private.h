...
typedef struct
{
	...
	okuma_mt__read_data_t read_cycle_time;
	okuma_mt__read_data_t read_part_program_name;
	okuma_mt__read_data_t read_machine_connection_status;
	okuma_mt__read_data_t read_machine_production_status;
			
	okuma_mt__machine_config_t config;
...
typedef struct
{
	...
	char agent_name[OKUMA_MT__CONFIG__BUFFER_SIZE_256];
...
int okuma_mt__private__disconnect_from_machine__real(int md);
int okuma_mt__private__disconnect_from_machine__simulated(int md);

int okuma_mt__private__reconnect_to_machine(int md);
int okuma_mt__private__reconnect_to_machine__real(int md);
int okuma_mt__private__reconnect_to_machine__simulated(int md);
