...
#define AGENTS__PROBABILITY_OF_SUCCESS_OF_EVENTS_IN_SIMULATION_MODE      95
...
int agents__load_configuration_data(agents_t* a);
...
//
//
//int agents__load_configuration_data(agent_machine_t* machine);
