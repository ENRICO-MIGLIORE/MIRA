...
#define AGENTS__MACHINE_ID                                               0
#define AGENTS__MACHINE_NAME                                             1





#define AGENTS__CONFIG__MAX_PATH_SIZE                                    1024
#define AGENTS__CONFIG__SDB_FIELDS_MAX                                   64
#define AGENTS__CONFIG__SDB_BUFFER_SIZE                                  (1024 * 128)
#define AGENTS__CONFIG__BUFFER_SIZE                                      AGENTS__CONFIG__MAX_PATH_SIZE
#define AGENTS__CONFIG__MAIN_THREAD_SLEEP_TIME_SECONDS                   5
#define AGENTS__CONFIG__MIN_LOG_FILE_LINES_PER_MINUTE                    60
#define AGENTS__CONFIG__TOKENS_MAX                                       32

#define AGENTS__CONFIG__MIN_PROBABILITY_OF_SUCCESS_OF_EVENTS_IN_SIMULATION_MODE      5
//#define AGENTS__PART_COUNTER_INITIAL_VALUE_IN_SIMULATION_MODE           100
//#define AGENTS__AVERAGE_CYCLE_TIME_IN_SIMULATION_MODE                  30.0


#define AGENTS__TYPE_1                                                   1



#define AGENTS__FILE_CONFIG_MODE                                 0
#define AGENTS__BUFFER_CONFIG_MODE                               1
#define AGENTS__UNESCAPE_SEQUENCE                                "!s"
#define AGENTS__UNESCAPE_SEQUENCE_LEN                            2
#define AGENTS__UNESCAPE_REPLACEMENT_CHAR                        ';'
#define AGENTS__FIELDS_SEPARATORS                                {";"}
#define AGENTS__FIELDS_SEPARATORS_MAX                            1
#define AGENTS__CHARACTER_TO_TRIM                                ' '
...
{
	int do_filtering;
	char prefix[AGENTS__CONFIG__BUFFER_SIZE];
	char suffix[AGENTS__CONFIG__BUFFER_SIZE];
	size_t prefix_len;
	size_t suffix_len;
...
typedef struct
{
	 ...
	 * MACHINE NAME
	 */
	char name[AGENTS__CONFIG__BUFFER_SIZE];
	 ...
	 */
	char opc_server_ipv4_address[AGENTS__CONFIG__BUFFER_SIZE];
	char opc_server_ipv4_port[AGENTS__CONFIG__BUFFER_SIZE];
	char opc_server_user_name[AGENTS__CONFIG__BUFFER_SIZE];
	char opc_server_password[AGENTS__CONFIG__BUFFER_SIZE];
	char opc_server_private_key_file[AGENTS__CONFIG__MAX_PATH_SIZE];
	char opc_server_certificate_file[AGENTS__CONFIG__MAX_PATH_SIZE];
	 ...
	 */
	char opc_server_part_counter_node_path[AGENTS__CONFIG__MAX_PATH_SIZE];
	char opc_server_cycle_time_node_path[AGENTS__CONFIG__MAX_PATH_SIZE];
	char opc_server_part_program_name_node_path[AGENTS__CONFIG__MAX_PATH_SIZE];
	...
	char part_program_name_in_simulation_mode[AGENTS__CONFIG__BUFFER_SIZE];
...
typedef struct
{
	...
	char part_counter[AGENTS__CONFIG__BUFFER_SIZE];
	int part_counter_simulation_mode_first_time;

	int cycle_time_valid;
	double cycle_time_native;
	char cycle_time[AGENTS__CONFIG__BUFFER_SIZE];

	int part_program_name_valid;
	char part_program_name[AGENTS__CONFIG__BUFFER_SIZE];
...
typedef struct
{
	...
	int enable_printf;
	int enable_log_file;
	char log_file_name[AGENTS__CONFIG__MAX_PATH_SIZE];
    ...
    //char agent_name[AGENTS__CONFIG__BUFFER_SIZE];
...
typedef struct
{
	...
	utils__sdb_t sdb;
	char sdb_buffer[AGENTS__CONFIG__SDB_BUFFER_SIZE];
	char* sdb_name[AGENTS__CONFIG__SDB_FIELDS_MAX];
	char* sdb_value[AGENTS__CONFIG__SDB_FIELDS_MAX];
	int sdb_encoding[AGENTS__CONFIG__SDB_FIELDS_MAX];
	size_t sdb_name_len[AGENTS__CONFIG__SDB_FIELDS_MAX];
	size_t sdb_value_len[AGENTS__CONFIG__SDB_FIELDS_MAX];

	utils__printf_t pf;

	agent__siemens_open62541__t* siemens_open62541;
...
int agents__load_agents_configuration_data(agency_t* a);
int agents__load_machines_configuration_data(agency_t* a, int* number_of_machines);
int agency__check_input_parameters_and_preproccess_input_data(agency_t* a, const char* calling_function_name, const char* data, size_t data_len, char** tokens, size_t* tokens_len, size_t tokens_max, size_t* token_count, size_t minimum_token_count);
...
//	 * MACHINE TYPE
//	 */
//	char type[AGENTS__CONFIG__BUFFER_SIZE];
//
//	/*
//	 * MACHINE PLATE DATA
//	 */
//	char manufacturer[AGENTS__CONFIG__BUFFER_SIZE];
//	char model[AGENTS__CONFIG__BUFFER_SIZE];
//	char serial_number[AGENTS__CONFIG__BUFFER_SIZE];
//	char manufacture_year[AGENTS__CONFIG__BUFFER_SIZE];
//
//	/*
//	 * MACHINE FIELD DATA
//	 */	
...
//	 */	
//	char organization[AGENTS__CONFIG__BUFFER_SIZE];
//	char facility[AGENTS__CONFIG__BUFFER_SIZE];
//	char department[AGENTS__CONFIG__BUFFER_SIZE];
//	char name[AGENTS__CONFIG__BUFFER_SIZE];
//
//	/*
//	 * MACHINE TECHNICAL DATA
//	 */
//	char cnc[AGENTS__CONFIG__BUFFER_SIZE];
//	char hmi[AGENTS__CONFIG__BUFFER_SIZE];
//
//
//	/*
//	 * MACHINE FEEDER DATA
//	 */
//	char feeder_manufacturer[AGENTS__CONFIG__BUFFER_SIZE];
//	char feeder_model[AGENTS__CONFIG__BUFFER_SIZE];
//	char feeder_serial_number[AGENTS__CONFIG__BUFFER_SIZE];
//	char feeder_manufacture_year[AGENTS__CONFIG__BUFFER_SIZE];
//
//
//
//
...
//
//
//	char opc_ipv4_address[AGENTS__CONFIG__BUFFER_SIZE];
//	char opc_ipv4_port[AGENTS__CONFIG__BUFFER_SIZE];
//	char opc_user_name[AGENTS__CONFIG__BUFFER_SIZE];
//	char opc_password[AGENTS__CONFIG__BUFFER_SIZE];
//	char opc_certificate_file[AGENTS__CONFIG__MAX_PATH_SIZE];
//	char opc_private_key_file[AGENTS__CONFIG__MAX_PATH_SIZE];
//
//
//	char opc_part_counter_path[AGENTS__CONFIG__MAX_PATH_SIZE];
//	char opc_cycle_time_path[AGENTS__CONFIG__MAX_PATH_SIZE];
//	char opc_part_program_name_path[AGENTS__CONFIG__MAX_PATH_SIZE];
//
...
//
//	char name_and_index[AGENTS__CONFIG__BUFFER_SIZE];
...
//	char part_counter_utf_8[AGENTS__CONFIG__BUFFER_SIZE];
...
//	char cycle_time_utf_8[AGENTS__CONFIG__BUFFER_SIZE];
//	size_t cycle_time_utf_8_len;
//
//	char part_program_name[AGENTS__CONFIG__BUFFER_SIZE];
//	int part_program_name_valid;
//	char part_program_name_simulated[AGENTS__CONFIG__BUFFER_SIZE];
//	int part_program_name_simulated_valid;
//	char part_program_name_utf_8[AGENTS__CONFIG__BUFFER_SIZE];
...
//	char agent_name_and_version[AGENTS__CONFIG__BUFFER_SIZE];
