...
typedef int (*i4_agent__connect_t) (void* arg);
...
//
//
//int i4_agency__load_agency_configuration_data(i4_agency_t* agency);
//int i4_agency__load_machines_configuration_data(i4_agency_t* agency);
//
//
...
//void i4_agency__suspend_thread(i4_machine_t* machine, size_t milliseconds);
//int i4_agency__convert_machine_descriptor_to_agent_descriptor(int md, int* ad, int* ag_md);
//int i4_agency__check_machine_and_input_parameters(i4_machine_t* machine, char* buffer, size_t buffer_size, size_t buffer_size_min, size_t* buffer_len);
//int i4_agency__get_machine_config_data(int data_id, int md, char* buffer, size_t buffer_size, size_t* buffer_len);
//
//
//
//int i4_agency__connect_to_machine(i4_machine_t* machine);
...
//int agent__check_config(i4_machine__config_t* config);
//
//
...
//typedef int (*i4_agent__connect_t) (int);
//typedef void* (*i4_agent__thread_t) (void* arg);
//
//
//
...
//typedef struct
//{
//	i4_agent__connect_t connect_to_machine;
//
//	agent__read_machine_data_t read_part_counter;
//
//} i4_machine__config_t;
...
//
//	i4_agent__connect_t connect_to_machine;
//	i4_agent__connect_t disconnect_from_machine;
//
...
//int machine__config(agent_machine_t* subagent, i4_machine__config_t* config);
