...
#define AGENCY__CONFIG__BUFFER_SIZE                                      AGENCY__CONFIG__MAX_PATH_SIZE
...
//#define AGENCY__PART_COUNTER_INITIAL_VALUE_IN_SIMULATION_MODE           100
...
typedef struct
{
	 ...
	 */
	char opc_server_ipv4_address[AGENCY__CONFIG__BUFFER_SIZE];
	char opc_server_ipv4_port[AGENCY__CONFIG__BUFFER_SIZE];
	char opc_server_user_name[AGENCY__CONFIG__BUFFER_SIZE];
	char opc_server_password[AGENCY__CONFIG__BUFFER_SIZE];
	char opc_server_private_key_file[AGENCY__CONFIG__MAX_PATH_SIZE];
	char opc_server_certificate_file[AGENCY__CONFIG__MAX_PATH_SIZE];
	 ...
	 */
	char opc_server_part_counter_node_path[AGENCY__CONFIG__MAX_PATH_SIZE];
	char opc_server_cycle_time_node_path[AGENCY__CONFIG__MAX_PATH_SIZE];
	char opc_server_part_program_name_node_path[AGENCY__CONFIG__MAX_PATH_SIZE];
