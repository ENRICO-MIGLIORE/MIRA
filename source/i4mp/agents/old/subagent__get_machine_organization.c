...
int subagent__get_machine_organization__22 (subagent_machine_t* machine, char* buffer, size_t buffer_size, size_t* buffer_len)
{
	...
	if (rc == 0)
	{
		strcpy(buffer, machine->config_2.organization);
