#ifndef AGENT__FANUC_FOCAS_PRIVATE_H
#define AGENT__FANUC_FOCAS_PRIVATE_H
...
typedef struct
{
	...
	fanuc_focas__machine__config_2_t config_2;
...
extern agent__fanuc_focas_t* agent__fanuc_focas;
