#ifndef AGENT__FANUC_FOCAS_H
#define AGENT__FANUC_FOCAS_H
...
} agent__fanuc_focas__config_t;


int agent__fanuc_focas__init (void);
int agent__fanuc_focas__config (agent__fanuc_focas__config_t* config);
int agent__fanuc_focas__start(void);

int agent__fanuc_focas__is_agent_configured (void);
