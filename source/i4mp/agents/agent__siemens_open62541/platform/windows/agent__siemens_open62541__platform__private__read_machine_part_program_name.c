...
int agent__siemens_open62541__platform__private__read_machine_part_program_name (void* arg)
{
	...
	//fn = "agent__siemens_open62541__platform__private__read_machine_part_program_name()";
	...
	strcpy(opc_node_path, machine->config_2.opc_ua_server_part_program_name_node_path);
