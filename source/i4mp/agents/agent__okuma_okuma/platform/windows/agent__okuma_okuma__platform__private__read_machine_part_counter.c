...
int agent__okuma_okuma__platform__read_machine_part_counter (machine_t* machine)
{
	return 0;
}

int agent__okuma_okuma__platform__private__read_machine_part_counter (void* arg)
{
