...
int agent__okuma_okuma__platform__private__read_machine_part_program_name (void* arg)
{
	...
	fn = "agent__okuma_okuma__read_machine_part_program_name()";
	...
	//fn = "agent__okuma_okuma__platform__private__read_machine_part_program_name()";
	...
	////memcpy(machine->part_program_name, (const void *) part_program_name.config_2, len);
	//memcpy(machine->part_program_name, (const void*) part_program_name.config_2, len);
...
//int agent__okuma_okuma__private__read_part_program_name__real(int md)
//{
//
//	UA_Variant value2;
//	UA_NodeId nodeId2;
