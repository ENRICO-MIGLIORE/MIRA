...
int carmelo__cncs__open62541_get_average_power  (UA_Client* client, char* path, unsigned long path_len, double *average_power)
{
	...
	{
		*average_power = *(UA_Double*)value2.data;
