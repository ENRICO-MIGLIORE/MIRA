...
int utils__sdb__read_configuration_from_buffer (void* p, utils__sdb_t* sdb, const char* file_name, utils__sdb__section_callback_t* section, utils__sdb__name_callback_t* names_values, size_t names_values_max, size_t start_record, size_t* record_number, int* end_of_file)
{
